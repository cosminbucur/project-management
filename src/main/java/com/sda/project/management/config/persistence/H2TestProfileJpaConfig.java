package com.sda.project.management.config.persistence;
...
public class H2TestProfileJpaConfig {
    ...
    public static final String MODEL_PACKAGE = "com.sda.project.management.model";
    public static final String REPOSITORY_PACKAGE = "com.sda.project.management.repository";
